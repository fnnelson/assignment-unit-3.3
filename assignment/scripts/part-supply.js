...
console.log(supplyChanges.pop()); //this both removes the last item and logs it at the same time.  We could also assign it to a variable if desired.
console.log('supplyChanges is now:', supplyChanges);
